...
symbols = [
    ...
    "CHZUSDT", "CHRUSDT", "RSRUSDT", "JASMYUSDT", "FILUSDT",
    "KSMUSDT", "KDAUSDT"
]
...
def handle_message(message):
    ...
    if symbol_input == "ETH":
        symbols_to_check = ["ETHUSDT", "ETHBTC"]
    else:
        if not symbol_input.endswith("USDT") and symbol_input != "ETHBTC":
            symbol_input += "USDT"
        symbols_to_check = [symbol_input]
...
"""
            ...
            bot.reply_to(message, "⚠️ Error getting data.")
